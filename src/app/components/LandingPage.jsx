...
export default function LandingPage() {
  return (
    ...
    <div className="flex flex-col justify-between h-screen bg-white px-8">
      ...
      <div>
        <Image src={"/New-image.png"} alt="skincare product" title='Quality skincare' width={'800'} height={'200'} className="bg-cover my-[10px]"/>
      </div>
      </div>
      <div className='grid grid-cols-3 justify-items-center justify-around px-6 py-10 bg-white shadow-md text-3xl font-serif mt-30'>
        <p>Trusted by over 200,000+ Customers</p>
        <span>
          <h2 className='text-5xl mb-2 text-center'>4.8</h2>
      ...
      <div className=' grid sm:grid-cols-2 md:grid-cols-5 justify-between mt-10 gap-6 items-center '>
        ...
        <p className='flex justify-center items-center '>Face serum - 70ml</p>
        <p className='flex justify-center items-center '>Price: NGN 25,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Moisturizing Face Wash</p>
        <p className='flex justify-center items-center'>Face Wash - 120ml</p>
        <p className='flex justify-center items-center'>Price: NGN 55,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Gentle cleanser</p>
        <p className='flex justify-center items-center'>Face cleanser - 140ml</p>
        <p className='flex justify-center items-center'>Price: NGN 28,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        <Image src={"https://buybetter.ng/wp-content/uploads/2023/08/blemishh.jpg"} alt='fourth-product' width={'200'} height={'200'}/>
        <p className='flex justify-center items-center mt-6'>Ceramide</p>
        <p className='flex justify-center items-center '>Foaming Cleanser - 400ml</p>
        <p className='flex justify-center items-center '>Price: NGN 95,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Fresh Kombucha</p>
        <p className='flex justify-center items-center '>Facial treatment - 250ml</p>
        <p className='flex justify-center items-center '>Price: NGN 85,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>CeraVe</p>
        <p className='flex justify-center items-center '>Hydrating cleanser - 236ml</p>
        <p className='flex justify-center items-center '>Price: NGN 45,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Garnier Skin Active</p>
        <p className='flex justify-center items-center '>Cleansing water - 250ml</p>
        <p className='flex justify-center items-center '>Price: NGN 30,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Paula's Choice</p>
        <p className='flex justify-center items-center '>Foaming Cleanser - 150ml</p>
        <p className='flex justify-center items-center '>Price: NGN 55,000</p>
        </div>
        <div className=' bg-slate-100 rounded-2xl py-8 px-8 shadow-2xl'>
        ...
        <p className='flex justify-center items-center mt-6'>Tatcha</p>
        <p className='flex justify-center items-center '>Skin boosting - 150ml</p>
        <p className='flex justify-center items-center '>Price: NGN 15,000</p>
        </div>
        </div>
      </div>
